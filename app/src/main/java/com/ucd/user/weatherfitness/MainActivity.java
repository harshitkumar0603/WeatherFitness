...
import com.ucd.user.weatherfitness.model.DBAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        TextView score_id = (TextView)findViewById(R.id.location_view);
        ...
        TextView iscore = (TextView)findViewById(R.id.score_ID);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    objEvent.AddEvent(MainActivity.this,null);
                } catch (Exception e) {
                    e.printStackTrace();
                }
